<template>
  ...
  >
        <a-steps :current="1" style="margin-bottom: 30px">
          <a-step>
        ...
        <a-row>
          <a-col span="12">
            <a-form-item
              ...
              label="用章归属">
              <a-input readonly placeholder="xxxxxx"/>
            </a-form-item>
            <a-form-item
              :labelCol="labelCol"
              :wrapperCol="wrapperCol"
              label="发往单位">
              <a-input placeholder="请填写发往单位" readonly/>
            </a-form-item>
          </a-col>
          ...
          <a-col span="12">
            ...
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="用章数量">
              <a-input readonly placeholder="请填写用章数量"/>
            </a-form-item>
          </a-col>
        </a-row>
...
<!--          </a-upload>-->
                ...
                <a-form-item
                  label="审批内容">
                  <a-textarea placeholder="请输入审批内容" readonly/>
                </a-form-item>
